      ...
      <div class="row g-4">
        <div class="col-lg-4">
          <div class="card card-custom p-4 mb-4">
            ...
            <div class="p-3 border border-primary border-2 rounded bg-light mb-3 position-relative">
              ...
              <div class="d-flex align-items-center gap-3">
                <i class="bi bi-credit-card-2-front fs-1 text-primary-custom"></i>
                <div>
              ...
              <div class="mt-3 text-end">
                <button class="btn btn-sm btn-link text-muted text-decoration-none">Editar</button>
              </div>
            </div>
            ...
            <div class="p-3 border rounded mb-3">
              <div class="d-flex align-items-center gap-3">
                ...
                <div>
                  <p class="mb-0 fw-bold text-muted">Mastercard terminada en 8899</p>
                  <small class="text-muted">Expira 08/25</small>
                </div>
              </div>
              <div class="mt-3 text-end">
                <button class="btn btn-sm btn-link text-muted text-decoration-none">Hacer principal</button>
          ...
          <div class="card card-custom p-4 bg-primary-custom text-white shadow-sm">
            ...
            <small class="opacity-75">Recarga saldo para reservar más rápido.</small>
            <button class="btn btn-light text-primary-custom fw-bold mt-3 btn-sm">Recargar Saldo</button>
          </div>
        </div>
          ...
          <div class="card card-custom p-4 shadow-sm border-0">
              ...
              <table class="table table-hover align-middle">
                <thead class="table-light">
                  <tr>
                    ...
                    <th scope="col" class="text-muted small text-end">FACTURA</th>
                  </tr>
                </thead>
                <tbody>
                  <tr>
                    ...
                    <td class="text-end">
                      <button class="btn btn-sm btn-light border"><i class="bi bi-download"></i> PDF</button>
                    </td>
                  </tr>
                  <tr>
                    <td>05 Dic 2023</td>
            ...
            <nav class="mt-3">
              <ul class="pagination justify-content-center">
                ...
                <li class="page-item"><a class="page-link text-primary-custom" href="#">Siguiente</a></li>
              </ul>
            </nav>
          </div>
        </div>
