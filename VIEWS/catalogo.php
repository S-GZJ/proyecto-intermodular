...
// Si está logueado, obtenemos su rol, nombre y la inicial para el avatar
...
// Definimos dinámicamente a dónde apuntan los enlaces del menú según el rol
...
<body class="bg-light">
    ...
    <div class="container" style="margin-top: 120px; margin-bottom: 50px;">
      ...
      <div class="row g-4">
         ...
         * Seleccionamos los usuarios con rol 'profesor' y unimos sus detalles (tarifa, bio, título)
         */
        ...
        // Si la consulta devuelve resultados, iteramos sobre ellos para crear las tarjetas
        if ($res && $res->num_rows > 0) {
            while($profe = $res->fetch_assoc()) {
                // Preparamos los datos de cada profesor
