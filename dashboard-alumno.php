  ...
  <body class="bg-light">
            ...
            <li class="nav-item dropdown">
              ...
              >
                ...
                <li>
                  ...
                  >
                    <img
                      src="https://placehold.co/30x30?text=S"
                      class="rounded-circle"
                      alt="Silvia"
                    />
                    <div class="overflow-hidden">
                      <div class="d-flex justify-content-between small">
                        <strong class="text-dark">Silvia P.</strong>
                        <span class="text-muted" style="font-size: 0.75rem"
                          >Ayer</span
                        >
                      </div>
                      <div class="text-muted text-truncate small">
                        Recuerda repasar las integrales para mañana.
                      </div>
                    </div>
                  </a>
                </li>
    ...
    <div class="container my-5">
      <div class="row align-items-center mb-5">
        <div class="col-md-8">
          <h2 class="fw-bold text-dark">¡Hola! ¿Listo/a para aprender?</h2>
          <p class="text-muted">
            Tienes <strong>1 clase confirmada</strong> próximamente.
          </p>
        </div>
      ...
      <div class="row g-4">
        <div class="col-lg-8">
          <div
            class="card card-custom p-4 mb-5 border-start border-4 border-primary"
          >
            <div class="row align-items-center">
              <div class="col-md-8">
                ...
                <p class="mt-3 text-muted mb-0">
                  <i class="bi bi-camera-video"></i> La sala se abrirá 5 minutos
                  antes.
                </p>
              </div>
          ...
          <div class="card card-custom p-3 mb-3">
            <div class="d-flex justify-content-between align-items-center">
              ...
              <div class="text-end">
                ...
                <div>
                  <button
                    class="btn btn-link text-danger text-decoration-none btn-sm p-0"
          ...
          <div class="card card-custom p-3 mb-3 bg-light border-0 opacity-75">
            <div class="d-flex justify-content-between align-items-center">
              <div class="d-flex gap-3 align-items-center">
                <div
                  class="text-center bg-white rounded p-2"
                  style="width: 60px"
                >
                ...
                <div>
                  ...
                  <small class="text-muted">
                    Prof. Marcos Gómez • Finalizada
                  </small>
                </div>
              </div>
              <div>
                <button
                  class="btn btn-outline-warning btn-sm border-2 fw-bold text-dark"
                >
        ...
        <div class="col-lg-4">
          <div
            class="card card-custom p-4 text-center sticky-top"
            style="top: 100px"
          >
            <div class="mb-3">
    ...
    <script>
      function cancelarReserva(boton) {
        ...
        if (confirm("¿Seguro que quieres cancelar esta solicitud de clase?")) {
          // Buscamos la tarjeta padre del botón
          ...
          // Eliminamos el elemento del DOM después de la animación
          setTimeout(() => {
            tarjeta.remove();
          }, 500);
        }
    ...
    <style>
      /* Animación suave para el botón de entrar a clase */
      @keyframes pulse {
        0% {
          box-shadow: 0 0 0 0 rgba(59, 179, 189, 0.7);
        }
        70% {
          box-shadow: 0 0 0 10px rgba(59, 179, 189, 0);
        }
        100% {
          box-shadow: 0 0 0 0 rgba(59, 179, 189, 0);
        }
      }
      .pulse-animation {
