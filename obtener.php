...
// Reutilizamos la conexión establecida en conexion.php para interactuar con la BD.
include "conexion.php";

/**
 * 2. CONSULTA SQL CON LÓGICA DE CONVERSACIÓN
 ...
 * - O (remitente 2 Y destinatario 1): Mensajes enviados por el usuario 2 (las respuestas).
 * 
 ...
 * Esta es la parte más importante para el frontend:
