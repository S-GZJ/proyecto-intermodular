<?php
session_start();
// Le pasamos a JavaScript si el usuario está logueado en PHP
          ...
          <div class="col-lg-8">
            ...
            <div class="accordion" id="accordionAyuda">
              <div class="accordion-item border-0 mb-3 shadow-sm rounded overflow-hidden">
                ...
                <div id="collapseOne" class="accordion-collapse collapse" data-bs-parent="#accordionAyuda">
  ...
  <div class="container text-center">
    ...
    <script>
      function verificarAccesoCatalogo(event) {
        ...
        // Usamos la variable PHP que nos dice si hay sesión iniciada
