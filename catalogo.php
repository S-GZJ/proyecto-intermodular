...
// Lógica de navegación: Definimos a qué panel y perfil debe ir el usuario según sea 'profesor' o 'alumno'
...
<head>
    ...
    <!-- Importación de librerías externas: Bootstrap para diseño y Bootstrap Icons para los iconos -->
